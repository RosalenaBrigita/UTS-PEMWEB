                        ...
                        <tbody>
                            ...
                            if(isset($_GET['search'])) {
                                ...
                                <tr>
                                    ...
                                    <td class = "actions">
                                    <a href="<?php echo "updatedriver.php?id_driver=".$data['id_driver']; ?>" >update<i class="fa-sharp fa-solid fa-pen"></i></a>
                                    &nbsp;&nbsp;
                                    <a href="<?php echo "deletedriver.php?id_driver=".$data['id_driver']; ?>" >delete<i class="fa-solid fa-trash"></i></a>
                                    </td>
                                </tr>
                                <?php endwhile ?>
