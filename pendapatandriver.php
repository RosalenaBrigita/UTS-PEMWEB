        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">PENDAPATAN DRIVER</span>
                </div>
                <div class="center">
                <?php
                            include ('conn.php');
                            $link_driver  = "driver.php";
                            $id_driver  = $_POST["id_driver"];
                            $bulan = $_POST["bulan"];

                            $query = "SELECT SUM(jumlah_km) AS km_sum, SUM(jumlah_km)*3000 AS pendapatan_sum FROM trans_upn WHERE id_driver = '$id_driver' AND MONTH(tanggal) = '$bulan' GROUP BY MONTH(tanggal)";
                            $result = mysqli_query($conn,$query);
                            echo "<a href = \"$link_driver\">Back</a>";
