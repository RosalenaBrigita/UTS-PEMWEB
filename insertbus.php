...
<body>
    ...
    <section class="dashboard">
        ...
        <h1><center>Insert Data Bus</center></h1>

        <form action="savebus.php" method="post">
        <table id="db">
            <tr>
                <td width="200">ID Bus</td>
                <td>:</td>
                <td><input type="number" name="id_bus" required></td>
            </tr>
            <tr>
                <td>Plat</td>
                <td>:</td>
            ...
            <tr>
                <td>Status</td>
                <td>:</td>
                <td><input type="number" name="status" size="30" required></td>
            </tr>
                <tr>
                    <td></td>
                    <td></td>
