...
<body>
    <div class="sidebar close">
            ...
            <li>
                ...
                <li><a href="<?php echo "pendapatandriver.php";?>"> Driver</a></li>
                <li><a href="<?php echo "pendapatankondektur.php";?>">Kondektur</a></li>
                </ul>
            </li>
            <li>
                <a href="#">
        ...
        <div class="dash-content">
            <div class="overview">
                <div class="title">
                    ...
                    <span class="text">DATA KONDEKTUR</span>
                </div>
                    ...
                    <table>
                        ...
                        <tbody>
                            ...
                            if(isset($_GET['search'])) {
                                ...
                                $query = "select * from driver where customerNumber like '%"
                            ...
                            <tr>
                                ...
                                <td class = "actions">
                                    <a href="<?php echo "updatekondektur.php?id_kondektur=".$data['id_kondektur']; ?>" >update<i class="fa-sharp fa-solid fa-pen"></i></a>
                                    &nbsp;&nbsp;
                                    <a href="<?php echo "deletekondektur.php?nama=".$data['nama']; ?>" >delete<i class="fa-solid fa-trash"></i></a>
                                </td>
                            </tr>
                            <?php endwhile ?>
