...
<head>
    ...
    <style>
        ...
        input[type=text]:hover,input[type=text-area]:hover, input[type=number]:hover, select[type=text]:hover{
            opacity:1;
            border:2px;
            border-color:#06194d;;
            border-style:groove;
...
<body>
    <div class="sidebar close">
        ...
        <ul class="nav-links">
            ...
            <li>
                <div class="iocn-link">
                <a href="<?php echo "driver.php"; ?>" class="active">
    ...
    <section class="dashboard">
        ...
        <h1><center>Update Data Driver </center></h1>
        <?php
        $id_driver = $_GET['id_driver'];
        $data = mysqli_query($conn, "SELECT * FROM driver WHERE id_driver='$id_driver'");
        while ($print = mysqli_fetch_array($data)){
            ?>
        
        <form action="updatedriver1.php" method="post">
            <table id="db">
                <tr>
                    <td width="200">ID Driver</td>
                    <td>:</td>
                    <td><input type="number" name="id_driver" value="<?php echo $print ['id_driver'];?>" readonly></td>
                </tr>
                <tr>
                    <td>Nama</td>
                    <td>:</td>
                    <td><input type="text" name="nama" size="30" value="<?php echo $print ['nama'];?> " required></td>
                </tr>
                <tr>
                    <td>Nomor SIM</td>
                    <td>:</td>
                    <td><input type="number" name="no_sim" size="30" value="<?php echo $print ['no_sim'];?>" required></td>
                </tr>
                    <td>Alamat</td>
                    <td>:</td>
                    <td><input type="text-area" name="alamat" size="30"  value="<?php echo $print ['alamat'];?>" required></td>
                </tr>
                <tr>
                    <td></td>
                    <td></td>
